...
There are working examples of the animated charts in the [shares](shares/) folder, however GitHub's CSP header prevents the scripts from running when viewed directly, so they look a little broken (until I find a workaround):
